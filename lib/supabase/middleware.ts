...
export async function updateSession(request: NextRequest) {
  ...
  const publicPaths = ["/login", "/register", "/verify", "/auth", "/blog", "/papers", "/terms", "/privacy", "/not-found", "/api/auth", "/api/cron", "/diagnostic", "/faq", "/topics", "/daily-quiz", "/study-resources", "/compare"];
